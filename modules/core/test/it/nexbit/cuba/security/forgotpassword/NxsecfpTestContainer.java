package it.nexbit.cuba.security.forgotpassword;
...
public class NxsecfpTestContainer extends TestContainer {

    public NxsecfpTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "it/nexbit/cuba/security/forgotpassword/app.properties",
    ...
    public static class Common extends NxsecfpTestContainer {

        public static final NxsecfpTestContainer.Common INSTANCE = new NxsecfpTestContainer.Common();
